...
public class GamePlay extends JPanel implements KeyListener, ActionListener {
	...
	//fruits parameters
	private int [] fruitXpos = {25,50,75,100,125,150,175,200,225,275,300,325,350,375,400,
			425,450,475,500,525,550,575,600,625,650,675,700,725,750,775,800,825,850};
	private int [] fruitYpos = {75,100,125,150,175,200,225,275,300,325,350,375,400,
	...
	public void paint(Graphics g) {
		...
		for(int i = 1;i<lengthofsnake;i++) {
			if(snakeXLength[i] == snakeXLength[0] && snakeYLength[i]==snakeYLength[0]) {
				...
				g.drawString("Press Enter to Restart! "+scores, 350, 340);
